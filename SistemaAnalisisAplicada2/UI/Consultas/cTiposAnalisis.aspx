<%@ Page Title="" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="cTiposAnalisis.aspx.cs" Inherits="SistemaAnalisisAplicada2.UI.Consultas.cTiposAnalisis" %>
			...
			<div class="row">
				<div class="col-md-2">
					<asp:DropDownList ID="BuscarPorDropDownList" runat="server" CssClass="form-control input-sm">
						...
						<asp:ListItem>Précio</asp:ListItem>
					</asp:DropDownList>
				</div>
				<div class="col-md-6">
				...
				<asp:GridView ID="DatosGridView"
					...
					<Columns>
						<asp:HyperLinkField ControlStyle-ForeColor="blue"
							DataNavigateUrlFields="Id_Tipo_Analisis"
							DataNavigateUrlFormatString="~/UI/Registros/rTiposAnalisis.aspx?Id={0}"
