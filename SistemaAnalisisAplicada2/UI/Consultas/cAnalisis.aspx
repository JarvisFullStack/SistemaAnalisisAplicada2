<%@ Page Title="" Language="C#" MasterPageFile="~/MainLayout.Master" AutoEventWireup="true" CodeBehind="cAnalisis.aspx.cs" Inherits="SistemaAnalisisAplicada2.UI.Consultas.cAnalisis" %>
			...
			<div class="row">
				<div class="col-md-2">
					<asp:DropDownList  ID="BuscarPorDropDownList" runat="server" CssClass="form-control input-sm">
						...
						<asp:ListItem>Código Paciente</asp:ListItem>
					</asp:DropDownList>
				</div>
				<div class="col-md-6">
				...
				<asp:GridView ID="DatosGridView"
					...
					<Columns>
						<asp:HyperLinkField ControlStyle-ForeColor="blue"
							DataNavigateUrlFields="Id_Analisis"
							DataNavigateUrlFormatString="~/UI/Registros/rAnalisis.aspx?idAnalisis={0}"
